    ...
    return BaseBottomSheet(
      ...
      body: Column(
        children: [
          ...
          UtilWidget.bottomSheetRow(
            Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_TELEPHONE_SVG,
          ...
          _buildDividerThick(),
          UtilWidget.bottomSheetRow(
            Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_OTHER_USER_SVG,
  ...
  Widget _buildLoginByFingerprint() {
    return UtilWidget.bottomSheetRow(
        controller.appController.isFaceID
            ? Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_FACEID_SVG
            : Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_FINGERPRINT_SVG,
        controller.appController.isFaceID
