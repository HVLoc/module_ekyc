          ...
          child: Column(
            children: [
              Row(
                ...
                children: [
                  SvgPicture.asset(
                    Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_LOGO_SUPPORT_SVG,
              ...
              sdsSBHeight25,
              _itemSupport(
                  icon: Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_ADDRESS_SVG,
                  title: LocaleKeys.support_address.tr,
                  content: controller.supportModel.address ?? "",
                  function: () {}),
              _itemSupport(
                  icon: Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_HOTLINE_SVG,
              ...
              _itemSupport(
                  icon: Assets
                      .PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_EMAIL_SUPPORT_SVG,
              ...
              _itemSupport(
                  icon: Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_WEB_SVG,
