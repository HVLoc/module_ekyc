...
Column _buildBody() {
  return Column(
    ...
    children: [
      ...
      Center(
        child: Image.asset(
            Assets.PACKAGES_SDS_ASSETS_ASSETS_JPG_IMG_CARD_CCCD_PNG),
      ),
      sdsSBHeight25,
      TextUtils(
      ...
      sdsSBPadding,
      _buildTitleGuide(Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_CARD_CCCD_SVG,
          LocaleKeys.authentication_guide_prepare_card.tr),
      // sdsSBHeight12,
      // _buildTitleGuide(Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_LIST_SVG,
      //     LocaleKeys.authentication_guide_check_information.tr),
      sdsSBHeight12,
      _buildTitleGuide(
          Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_NFC_CONNECT_SVG,
          LocaleKeys.authentication_guide_nfc_scan.tr),
      sdsSBHeight12,
      _buildTitleGuide(Assets.PACKAGES_SDS_ASSETS_ASSETS_SVG_ICON_LIVE_NESS_SVG,
