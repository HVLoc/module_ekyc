...
class LiveNessCollection {
  ...
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_LEFT_SVG,
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_RIGHT_SVG,
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_BETWEEN_SVG,
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_UP_SVG,
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_SMILE_SVG,
  //   Assets.PACKAGES_SDS_ASSETS_ASSETS_IMAGES_ICON_ICON_SVG_ICON_FACE_BLINK_SVG,
  // ];
